    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Food>().HasData(
                new Food { Id = 1, Name = "Pizza", Calorie = 1400m, Fats = 13.4m, Salts = 14m, Protein = 10m, GramsInPortion = 160 },
                new Food { Id = 2, Name = "Spaghetti", Calorie = 900m, Fats = 16.4m, Salts = 18m, Protein = 20m, GramsInPortion = 30m },
                new Food { Id = 3, Name = "Chicken Breast", Calorie = 165m, Fats = 3.6m, Salts = 0.7m, Protein = 31m, GramsInPortion = 100 },
                new Food { Id = 4, Name = "Apple", Calorie = 52m, Fats = 0.2m, Salts = 0m, Protein = 0.3m, GramsInPortion = 150 },
                new Food { Id = 5, Name = "Banana", Calorie = 89m, Fats = 0.3m, Salts = 0m, Protein = 1.1m, GramsInPortion = 120 },
                new Food { Id = 6, Name = "Broccoli", Calorie = 55m, Fats = 0.6m, Salts = 0.05m, Protein = 3.7m, GramsInPortion = 100 },
                new Food { Id = 7, Name = "Salmon", Calorie = 208m, Fats = 13m, Salts = 0.1m, Protein = 20m, GramsInPortion = 100 },
                new Food { Id = 8, Name = "Avocado", Calorie = 160m, Fats = 15m, Salts = 0.01m, Protein = 2m, GramsInPortion = 100 },
                new Food { Id = 9, Name = "Rice", Calorie = 130m, Fats = 0.3m, Salts = 0m, Protein = 2.7m, GramsInPortion = 100 },
                ...
                new Food { Id = 12, Name = "Orange", Calorie = 47m, Fats = 0.1m, Salts = 0m, Protein = 0.9m, GramsInPortion = 130 },
